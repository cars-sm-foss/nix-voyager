...
# a nix source (e.g. the result of fetchurl {}) containing the virtualenv source dist
, virtualEnvSrc ? null

# some source dists (looking at you, numpy) have build-time dependencies or other
# constraints/pre-requisites on the python build env
...
mkDockerBuild {
  ...
  nixVoyagerExpressionArgs = {
    ...
    pythonBuildDependencies = "_voyager_path_list_" + builtins.concatStringsSep ":" pythonBuildDependencies;
  };
